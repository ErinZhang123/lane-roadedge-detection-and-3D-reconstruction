...
def train_net(dataset_dir, weights_path=None, net_flag='vgg'):
    ...
    model_save_dir = 'model/tusimple_lanenet_2'
    ...
    # Set tf summary
    tboard_save_path = 'tboard/tusimple_lanenet/vgg2'#'tboard/tusimple_lanenet/{:s}'.format(net_flag)
    ...
    with sess.as_default():
        ...
        for epoch in range(train_epochs):
            ...
            if epoch % 20 == 0:
                ...
                cv2.imwrite('binary_label.png', binary_gt_labels[0] * 255/2)
